  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 sm:p-8">
      <div className="w-full bg-white shadow-2xl rounded-lg">
        ...
        <header className="bg-white text-slate-800 p-6 sm:p-8 rounded-t-lg">
          <div className="flex justify-between items-center flex-wrap gap-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-slate-800">GOU STORES</h1>
            ...
            <div className="text-right">
              <h2 className="text-4xl font-extrabold tracking-wide text-slate-800">INVENTORY REPORT</h2>
              <p className="text-slate-600 mt-1">As of: {generatedDate}</p>
            </div>
          </div>
        </header>
        ...
        {/* Footer Section */}
        <footer className="bg-white text-slate-800 p-6 sm:p-8 rounded-b-lg mt-8 border border-gray-200">
          <div className="flex justify-between items-center flex-wrap gap-4">
            <div className="w-2/5">
              <p className="font-semibold text-slate-800">Generated By:</p>
              <p className="text-slate-600 mt-1">{generatedBy}</p>
            </div>
            <p className="text-slate-600 text-sm">Page 1 of 1</p>
            <div className="text-right">
              <p className="text-slate-600 text-sm">GOU STORES</p>
              <p className="text-slate-500 text-xs">Government of Uganda</p>
            </div>
          </div>
        </footer>
      </div>
