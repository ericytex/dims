  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 sm:p-8">
      <div className="max-w-7xl mx-auto bg-white shadow-2xl rounded-lg">
        ...
        <header className="bg-white text-slate-800 p-6 sm:p-8 rounded-t-lg border border-gray-200">
          <div className="flex justify-between items-center flex-wrap gap-4">
            ...
            <div className="text-right">
              <h2 className="text-4xl font-extrabold tracking-wide text-slate-800">TRANSACTIONS REPORT</h2>
        ...
        {/* Footer Section */}
        <footer className="bg-white text-slate-800 p-6 sm:p-8 rounded-b-lg border border-gray-200">
          <div className="flex justify-between items-center flex-wrap gap-4">
            <div className="w-2/5">
