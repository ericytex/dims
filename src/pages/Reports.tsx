...
export default function Reports() {
  ...
  const generatePDFReport = async () => {
    ...
    try {
      ...
      // addNotification('PDF report generated successfully!', 'success'); // This line was removed as per the edit hint
    } catch (error) {
      console.error('Error generating PDF:', error);
      // addNotification('Failed to generate PDF report', 'error'); // This line was removed as per the edit hint
    } finally {
